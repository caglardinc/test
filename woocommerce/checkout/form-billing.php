...
<div class="woocommerce-billing-fields">
	<?php if ( wc_ship_to_billing_address_only() && WC()->cart->needs_shipping() ) : ?>
		...
		<h4 class="border-bottom pb-4"><i class="ti ti-user mr-3 text-primary"></i><?php esc_html_e('Basic information','soup'); ?></h4>
		...
		<?php if ( ! $checkout->is_registration_required() ) : ?>
			...
			<p class="form-row form-row-wide create-account">
				<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox custom-checkbox">
					...
					<span class="cant"><?php esc_html_e( 'Create an account?', 'soup' ); ?></span>
				</label>
			</p>
